...
import { HomeContentCardsFragmentContainer } from "./Components/HomeContentCards"
...
export const HomeApp: React.FC<HomeAppProps> = ({
  ...
  return (
    <>
      ...
      <HomeContentCardsFragmentContainer heroUnits={heroUnitsConnection} />
